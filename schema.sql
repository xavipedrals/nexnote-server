...
-- No policies: only the service role (edge function) writes/reads. Public
-- form submissions go through `submit-report`.
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."flashcard_decks";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."note_sources";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."podcasts";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."summary_jobs";
